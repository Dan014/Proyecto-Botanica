...
public class JPanelNorthButonTable extends JPanel  {

	JPanel jPanelNorth;
	JButton jButton, jButton2, jButton3, jButton4, find;
	ImageIcon imageIcon;
	Icon icon;
//        JDialogAddCost jDialogAddCost;
	public JPanelNorthButonTable(Control control) {
...
//		jPanelNorth.add(create("Buscar Producto", "/images/busqueda.png", Commands.C_AVERAGE.name()));
		...
		jButton = new JButton(HandlerLanguage.languageProperties.getProperty(ConstantsBotanic.ADDPLANT));
		jButton.setBounds(0, 0, 200, 100);
		jButton.setActionCommand(Commands.SHOW_CREATE_PLANT.name());
		...
		jButton2.setActionCommand(Commands.SAVE_JSON.name());
		...
		jButton4.setActionCommand(Commands.SAVEXML.name());
		...
		jButton3 = new JButton(HandlerLanguage.languageProperties.getProperty(ConstantsBotanic.CHANGEDPALNT));
		jButton3.setBounds(0, 0, 200, 100);
		jButton3.setActionCommand(Commands.SHOW_CHANGEPLANT.name());
		...
		imageIcon = new ImageIcon(getClass().getResource("/images/editar.png"));
		icon = new ImageIcon(imageIcon.getImage().getScaledInstance(50, 50, Image.SCALE_AREA_AVERAGING));
	...
	public void changeLanguage() {
		jButton.setText(HandlerLanguage.languageProperties.getProperty(ConstantsBotanic.ADDPLANT));
