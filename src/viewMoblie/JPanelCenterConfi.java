...
public class JPanelCenterConfi extends JPanel {
	private JPanel jPanelWest, jPanelEast, jPanelCenter, jPanelNorth, jPanel;
	private JPanelConfi jPanleFilterMobile;
	private JPanelNorthTitle jPanelNorthTitle;

	public JPanelCenterConfi(Control control) {
		jPanelNorthTitle = new JPanelNorthTitle(300, Color.WHITE);
		...
		jPanleFilterMobile = new JPanelConfi(control);
	...
	private void init() {
		...
		this.add(jPanelNorthTitle, BorderLayout.SOUTH);
