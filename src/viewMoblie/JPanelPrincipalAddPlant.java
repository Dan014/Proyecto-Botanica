...
public class JPanelPrincipalAddPlant extends JPanel {
	private JPanelSouth2 jPanelSouth;
	private JPanelCenterAddPlant jPanelCenter;
	...
	public JPanelPrincipalAddPlant(Control control) {
		this.jPanelSouth = new JPanelSouth2(control);
		this.jPanelCenter = new JPanelCenterAddPlant(control);
	...
	public JPanelCenterAddPlant getJPanelCenterAddPlant() {
		return jPanelCenter;
