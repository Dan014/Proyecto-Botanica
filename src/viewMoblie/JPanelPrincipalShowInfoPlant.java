...
public class JPanelPrincipalShowInfoPlant extends JPanel {
	private JPanelSouth2 jPanelSouth;
	private JPanelCenterInfoPlant jPanelCenter;
	...
	public JPanelPrincipalShowInfoPlant(Control control) {
		this.jPanelSouth = new JPanelSouth2(control);
		this.jPanelCenter = new JPanelCenterInfoPlant(control);
