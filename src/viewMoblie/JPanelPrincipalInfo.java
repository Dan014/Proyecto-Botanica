...
public class JPanelPrincipalInfo extends JPanel {
	private JPanelSouth2 jPanelSouth;
	private JPanelCenterInfo jPanelCenter;
	...
	public JPanelPrincipalInfo(Control control) {
		this.jPanelSouth = new JPanelSouth2(control);
		this.jPanelCenter = new JPanelCenterInfo(control);
