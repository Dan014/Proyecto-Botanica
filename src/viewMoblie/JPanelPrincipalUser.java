...
public class JPanelPrincipalUser extends JPanel {
	private JPanelSouth2 jPanelSouth;
	private JPanelCenterUser jPanelCenter;
	...
	public JPanelPrincipalUser(Control control) {
		this.jPanelSouth = new JPanelSouth2(control);
		this.jPanelCenter = new JPanelCenterUser(control);
